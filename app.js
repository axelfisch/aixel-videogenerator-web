...
// envoi. On conserve davantage de détails quand le projet demande une sortie 720p, tout en restant
// sous la limite de taille de la requête Netlify après l'encodage base64.
...
// Correctif du 2026-09-02 (deux étapes) : l'URL Replicate de la vidéo générée n'a pas d'en-têtes
// CORS permissifs — un fetch() direct échouait ("Failed to fetch", confirmé en direct). Un premier
// correctif la rapatriait en base64 côté serveur, mais ça se heurtait à la limite de réponse des
// fonctions Netlify (~6 Mo) pour les vidéos un peu plus lourdes — pas un cas rare. Solution
